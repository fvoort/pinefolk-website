...
This is a boilerplate that **works for me**, so please don’t propose changes. If you do however find a bug, please raise an issue first before a pull request.
